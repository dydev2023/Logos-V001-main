                                ...
                                <div class="row">
                                    ...
                                    <div class="col-12 col-sm-4">
                                        <div class="form-group local-forms">
                                            ...
                                            <input class="form-control <?php echo $u_id_red_border ?>" type="text" name="u_id" value="<?php echo $t_row['u_id'] ?>" readonly>
                                    ...
                                    <div class="col-12 col-sm-4">
                                        <div class="form-group local-forms">
                                            ...
                                            <input class="form-control <?php echo $fname_ch_red_border ?>" type="text" name="fname_ch" value="<?php echo $t_row['fname_ch'] ?>">
                                    ...
                                    <div class="col-12 col-sm-4">
                                        <div class="form-group local-forms">
                                            ...
                                            <input class="form-control <?php echo $lname_ch_red_border ?>" type="text" name="lname_ch" value="<?php echo $t_row['lname_ch'] ?>">
                                    ...
                                    <div class="col-12 col-sm-4">
                                        <div class="form-group local-forms calendar-icon">
                                            ...
                                            <input class="form-control datetimepicker <?php echo $dob_red_border ?>" type="text" name="dob" value="<?php echo $t_row['dob'] ?>">
                                    ...
                                    <div class="col-12 col-sm-4">
                                        <div class="form-group local-forms">
                                            ...
                                            <input class="form-control <?php echo $nation_red_border ?>" type="text" name="nation" value="<?php echo $t_row['nation'] ?>">
                                    ...
                                    <div class="col-12 col-sm-4"> <!--New element -->
                                        <div class="form-group local-forms">
                                            ...
                                            <input class="form-control <?php echo $ethnicity_red_border ?>" type="text" name="ethnicity" value="<?php echo $t_row['ethnicity'] ?>">
                                    ...
                                    <div class="col-12 col-sm-4">
                                        <div class="form-group local-forms">
                                            ...
                                            <input class="form-control <?php echo $tel_red_border ?>" type="text" name="tel" value="<?php echo $t_row['tel'] ?>">
                                    ...
                                    <div class="col-12 col-sm-4">
                                        <div class="form-group local-forms">
                                            ...
                                            <input class="form-control <?php echo $email_red_border ?>" type="text" name="email" value="<?php echo $t_row['email'] ?>">
                                    ...
                                    <div class="col-12 col-sm-4"> <!--New element -->
                                        <div class="form-group local-forms">
                                            ...
                                            <input class="form-control <?php echo $emergency_tel_red_border ?>" type="text" name="emergency_tel" value="<?php echo $t_row['emergency_tel'] ?>">
                                    ...
                                    <div class="col-12 col-sm-4"> <!--New element -->
                                        <div class="form-group local-forms">
                                            ...
                                            <input class="form-control <?php echo $emergency_name_red_border ?>" type="text" name="emergency_name" value="<?php echo $t_row['emergency_name'] ?>">
                                    ...
                                    <div class="col-12 col-sm-4"> <!--New element -->
                                        <div class="form-group local-forms">
                                            ...
                                            <input class="form-control <?php echo $village_birth_red_border ?>" type="text" name="village_birth" value="<?php echo $t_row['village_birth'] ?>">
                                    ...
                                    <div class="col-12 col-sm-4"> <!--New element -->
                                        <div class="form-group local-forms">
                                            ...
                                            <input class="form-control <?php echo $district_birth_red_border ?>" type="text" name="district_birth" value="<?php echo $t_row['district_birth'] ?>">
                                    ...
                                    <div class="col-12 col-sm-4"> <!--New element -->
                                        <div class="form-group local-forms">
                                            ...
                                            <input class="form-control <?php echo $province_birth_red_border ?>" type="text" name="province_birth" value="<?php echo $t_row['province_birth'] ?>">
                                    ...
                                    <div class="col-12 col-sm-4">
                                        <div class="form-group local-forms">
                                            ...
                                            <input class="form-control <?php echo $village_current_red_border ?>" type="text" name="village_current" value="<?php echo $t_row['village_current'] ?>">
                                    ...
                                    <div class="col-12 col-sm-4">
                                        <div class="form-group local-forms">
                                            ...
                                            <input class="form-control <?php echo $district_current_red_border ?>" type="text" name="district_current" value="<?php echo $t_row['district_current'] ?>">
                                    ...
                                    <div class="col-12 col-sm-4">
                                        <div class="form-group local-forms">
                                            ...
                                            <input class="form-control <?php echo $province_current_red_border ?>" type="text" name="province_current" value="<?php echo $t_row['province_current'] ?>">
                                    ...
                                    <div class="col-12 col-sm-4"> <!--New element -->
                                        <div class="form-group local-forms">
                                            ...
                                            <input class="form-control <?php echo $house_unit_red_border ?>" type="text" name="house_unit" value="<?php echo $t_row['house_unit'] ?>">
                                    ...
                                    <div class="col-12 col-sm-4"> <!--New element -->
                                        <div class="form-group local-forms">
                                            ...
                                            <input class="form-control <?php echo $house_no_red_border ?>" type="text" name="house_no" value="<?php echo $t_row['house_no'] ?>">
                                    ...
                                    <div class="col-12 col-sm-4">
                                        <div class="form-group local-forms">
                                            ...
                                            <input class="form-control <?php echo $edu_branch1_red_border ?>" type="text" name="edu_branch1" value="<?php echo $t_row['edu_branch1'] ?>">
                                    ...
                                    <div class="col-12 col-sm-4">
                                        <div class="form-group local-forms">
                                            ...
                                            <input class="form-control <?php echo $univ_name1_red_border ?>" type="text" name="univ_name1" value="<?php echo $t_row['univ_name1'] ?>">
                                    ...
                                    <div class="col-12 col-sm-4">
                                        <div class="form-group local-forms">
                                            ...
                                            <input class="form-control <?php echo $edu_district1_red_border ?>" type="text" name="edu_district1" value="<?php echo $t_row['edu_district1'] ?>">
                                    ...
                                    <div class="col-12 col-sm-4">
                                        <div class="form-group local-forms">
                                            ...
                                            <input class="form-control <?php echo $edu_province1_red_border ?>" type="text" name="edu_province1" value="<?php echo $t_row['edu_province1'] ?>">
                                    ...
                                    <div class="col-12 col-sm-4">
                                        <div class="form-group local-forms">
                                            ...
                                            <input class="form-control <?php echo $edu_season1_red_border ?>" type="text" name="edu_season1" value="<?php echo $t_row['edu_season1'] ?>">
                                    ...
                                    <div class="col-12 col-sm-4">
                                        <div class="form-group local-forms">
                                            ...
                                            <input class="form-control" type="text" name="edu_branch2" value="<?php echo $t_row['edu_branch2'] ?>">
                                    ...
                                    <div class="col-12 col-sm-4">
                                        <div class="form-group local-forms">
                                            ...
                                            <input class="form-control" type="text" name="univ_name2" value="<?php echo $t_row['univ_name2'] ?>">
                                    ...
                                    <div class="col-12 col-sm-4">
                                        <div class="form-group local-forms">
                                            ...
                                            <input class="form-control" type="text" name="edu_district2" value="<?php echo $t_row['edu_district2'] ?>">
                                    ...
                                    <div class="col-12 col-sm-4">
                                        <div class="form-group local-forms">
                                            ...
                                            <input class="form-control" type="text" name="edu_province2" value="<?php echo $t_row['edu_province2'] ?>">
                                    ...
                                    <div class="col-12 col-sm-4">
                                        <div class="form-group local-forms">
                                            ...
                                            <input class="form-control" type="text" name="edu_season2" value="<?php echo $t_row['edu_season2'] ?>">
                                        </div>
                                    </div>
                                    <div class="col-12 col-sm-4"> <!--New element -->
                                        <div class="form-group local-forms">
                                            <label>Employment History</label>
                                            <input class="form-control" type="text" name="employment_history" value="<?php echo $t_row['employment_history'] ?>">
                                        </div>
                                    </div>
                                    <div class="col-12 col-sm-4"> <!--New element -->
                                        <div class="form-group local-forms">
                                            <label>Language Proficiency </label>
                                            <input class="form-control" type="text" name="language_proficiency" value="<?php echo $t_row['language_proficiency'] ?>">
                                        </div>
                                    </div>
                                    <div class="col-12 col-sm-4"> <!--New element -->
                                        <div class="form-group local-forms">
                                            <label>Talent </label>
                                            <input class="form-control" type="text" name="talent" value="<?php echo $t_row['talent'] ?>">
                                        </div>
                                    </div>
                                    <div class="col-12 col-sm-4">
                                        <div class="form-group local-forms">
                                            <label>Family Matters </label>
                                            <input class="form-control" type="text" name="familymatters" value="<?php echo $t_row['familymatters'] ?>">
                                        </div>
                                    </div>
                                    <div class="col-12 col-sm-4">
                                        <div class="form-group local-forms">
                                            <label>Plans For Future </label>
                                            <input class="form-control" type="text" name="plansforthefuture" value="<?php echo $t_row['plansforthefuture'] ?>">
                                        </div>
                                    </div>
                                    <div class="col-12 col-sm-4">
                                        <div class="form-group local-forms">
