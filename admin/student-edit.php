                            ...
                            <div class="card-body">
                                ...
                                <form method="post" action="" enctype="multipart/form-data">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-12 col-sm-4"> <!--New element -->
                                            <div class="form-group local-forms">
                                                <label>Villages High School<span class="login-danger">*</span></label>
                                                <input class="form-control <?php echo $village_study_red_border ?>" type="text" name="village_study" value="<?php echo $std_row['village_study'] ?>">
                                        ...
                                        <div class="col-12 col-sm-4">
                                            <div class="form-group students-up-files">
                                                ...
                                                <?php $studentImage_file = $std_row['image'] ?>
