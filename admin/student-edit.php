            ...
            if (
                ...
                try {
                    ...
                    */
                    ...
                    nation=:nation, religion=:religion, highschool=:highschool, elementaryschool=:elementaryschool,
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-12 col-sm-4">           <!--New element -->
                                            <div class="form-group local-forms">
                                                ...
                                                <input class="form-control <?php echo $village_of_birth_red_border ?>" type="text" name="village_of_birth" value="">
                                        ...
                                        <div class="col-12 col-sm-4">       <!--New element -->
                                            <div class="form-group local-forms">
                                                ...
                                                <input class="form-control <?php echo $district_of_birth_red_border ?>" type="text" name="district_of_birth" value="">
                                        ...
                                        <div class="col-12 col-sm-4">           <!--New element -->
                                            <div class="form-group local-forms">
                                                ...
                                                <input class="form-control <?php echo $province_of_birth_red_border ?>" type="text" name="province_of_birth" value="">
                                        ...
                                        <div class="col-12 col-sm-4">       <!--New element -->
                                            <div class="form-group local-forms">
                                                ...
                                                <input class="form-control <?php echo $ethnicity_red_border ?>" type="text" name="ethnicity" value="">
                                        ...
                                        <div class="col-12 col-sm-4">       <!--New element -->
                                            <div class="form-group local-forms">
                                                ...
                                                <input class="form-control <?php echo $unit_red_border ?>" type="text" name="unit" value="">
                                        ...
                                        <div class="col-12 col-sm-4">           <!--New element -->
                                            <div class="form-group local-forms">
                                                ...
                                                <input class="form-control <?php echo $house_no_red_border ?>" type="text" name="house_no" value="">
                                        ...
                                        <div class="col-12 col-sm-4">               <!--New element -->
                                            <div class="form-group local-forms">
                                                ...
                                                <input class="form-control <?php echo $guadian_tel_red_border ?>" type="text" name="guadian_tel" value="">
                                        ...
                                        <div class="col-12 col-sm-4">       <!--New element -->
                                            <div class="form-group local-forms">
                                                ...
                                                <input class="form-control" type="text" name="emp_history" value="">
                                            </div>
                                        </div>
                                        <div class="col-12 col-sm-4">
                                            <div class="form-group local-forms">
                                        ...
                                        <div class="col-12 col-sm-4">           <!--New element -->
                                            <div class="form-group local-forms">
                                                ...
                                                <input class="form-control" type="text" name="lg_proficiency" value="">
                                            </div>
                                        </div>
                                        <div class="col-12 col-sm-4">
                                            <div class="form-group local-forms">
                                        ...
                                        <div class="col-12 col-sm-4">
                                            <div class="form-group students-up-files">
                                                <label>Upload Student Photo 3x4cm (<?php echo $s_row['image'] ?>) <span class="login-danger">*</span> </label>
