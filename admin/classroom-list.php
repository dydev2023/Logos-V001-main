                            ...
                            <div class="page-header">
                                <div class="row align-items-center">
                                    ...
                                    <div class="col-auto text-end float-end ms-auto download-grp">
                                        <a href="classroom-add.php" class="btn btn-primary"><i class="fas fa-plus"></i></a>
                                    </div>
                                </div>
                            </div>
                                        ...
                                        if ($classrooms == "No Classroom!") { ?>
                                            ...
                                            foreach ($classrooms as $classroom) {
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-end">
                                                        <div class="actions ">
                                                            <a href="classroom-edit.php?id=<?= $classroom['id'] ?>" class="btn btn-sm bg-danger-light">
                                                                <i class="feather-edit"></i>
                                                            </a>
                                                            <a href="classroom-delete.php?id=<?= $classroom['id'] ?>" class="btn btn-sm bg-danger-light" onclick="return confirm('Do you want to delete this item?')">
