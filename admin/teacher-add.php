...
if (!isset($_SESSION['admin_login'])) {
    ...
    if (isset($_REQUEST['submit'])) {
        ...
        if (
            ...
            !empty($nation) && !empty($religion) && !empty($highschool) && !empty($university) && !empty($image_file) && filter_var($_REQUEST['email'], FILTER_VALIDATE_EMAIL)
        ) {
            try {
                $status = 'Teacher';
                ...
                if ($type == "image/jpg" || $type == 'image/jpeg' || $type == "image/png" || $type == "image/gif") {
                    ...
                    // Add Admin
                    $stmt2 = $conn->prepare('INSERT INTO teachers(id,t_id, fname_en, lname_en, fname_la, lname_la, fname_ch, lname_ch, gender, dob, tel, whatsapp, email, village, district, province, nation, religion, university, highschool, image) 
                                        VALUES(LAST_INSERT_ID(), :t_id, :fname_en, :lname_en, :fname_la, :lname_la, :fname_ch, :lname_ch, :gender, :dob, :tel, :whatsapp, :email, :village, :district, :province, :nation, :religion, :university, :highschool, :image)');
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-12 col-sm-4">
                                            <div class="form-group local-forms">
                                                ...
                                                <input class="form-control <?php echo $university_red_border ?>" type="text" name="university" value="<?php echo $university ?>">
