    ...
    if (isset($_REQUEST['submit'])) {
        try {
            ...
            if (
                ...
                // Add Teacher
                $stmt2 = $conn->prepare('INSERT INTO teachers(t_id, u_id, fname_en, lname_en, gender, fname_la, lname_la, tel, email) 
                                    VALUES(:t_id, :u_id, :fname_en, :lname_en, :gender, :fname_la, :lname_la, :tel, :email)');
