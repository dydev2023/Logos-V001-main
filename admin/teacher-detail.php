                ...
                <div class="page-header">
                    <div class="row">
                        <div class="col">
                            ...
                            <ul class="breadcrumb">
                                <li class="breadcrumb-item"><a href="teacher-list.html">Teacher</a></li>
                        ...
                        <div class="profile-header">
                            <div class="row align-items-center">
                                ...
                                <div class="col ms-md-n2 profile-user-info">
                                    ...
                                    <h6 class="text-muted">status(teacher)</h6>
                            ...
                            <div class="col-lg-9">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div class="row">
                                            <p class="col-sm-3 text-muted text-sm-end mb-0 mb-sm-3">Tacher Type:</p>
                                            <p class="col-sm-9">Invited Professor</a></p>
                                        </div>
                                        <div class="row">
                                        ...
                                        <div class="row">
                                            <p class="col-sm-3 text-muted text-sm-end mb-0 mb-sm-3">Graduation Year:</p>
                                            <p class="col-sm-9">2019</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
