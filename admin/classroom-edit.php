                        ...
                        <div class="card comman-shadow">
                            <div class="card-body">
                                <form method="post" action="" enctype="multipart/form-data">
                                    ...
                                    <div class="row">
                                        <div class="col-12">
                                            <h5 class="form-title student-info">Classroom Information <span><a href="javascript:;"><i class="feather-more-vertical"></i></a></span></h5>
                                        </div>
                                        <div class="col-12 col-sm-4">
                                            <div class="form-group local-forms">
                                                <label>classroom<span class="login-danger">*</span> </label>
                                                <input class="form-control <?php echo $classroom_red_border ?>" type="text" value="<?php echo $classroomID['classroom'] ?>" name="classroom">
