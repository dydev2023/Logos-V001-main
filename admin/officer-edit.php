...
$lname_ch_err = $tel_err = $whatsapp_err = $email_err = $village_err = $district_err = $province_err = $emp_history_err = '';
$nation_err = $religion_err  = $university_err = $image_file_err = $ethnicity_err = $position_err = $lg_proficiency_err = '';
...
$nation_red_border = $religion_red_border = $university_red_border = $ethnicity_red_border = $position_red_border = $emp_history_red_border = $lg_proficiency_red_border = '';
            ...
            try {
                ...
                if ($type == "image/jpg" || $type == 'image/jpeg' || $type == "image/png" || $type == "image/gif") {
                    ...
                    $stmt2 = $conn->prepare('INSERT INTO teachers(id,officer, fname_en, lname_en, fname_la, lname_la, fname_ch, lname_ch, gender, dob, tel, whatsapp, email, village, district, province, nation, religion, university, image) 
                                        VALUES(LAST_INSERofficer(), :officer, :fname_en, :lname_en, :fname_la, :lname_la, :fname_ch, :lname_ch, :gender, :dob, :tel, :whatsapp, :email, :village, :district, :province, :nation, :religion, :university, :image)');
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-12 col-sm-4">       <!-- New elemant -->
                                            <div class="form-group local-forms">
                                                ...
                                                <input class="form-control <?php echo $emp_history_red_border ?>" type="text" name="emp_history" value="<?php echo $emp_history ?>">
                                                <div class="error"><?php echo $emp_history_err ?></div>
                                            </div>
                                        </div>
                                        <div class="col-12 col-sm-4">       <!-- New elemant -->
                                            <div class="form-group local-forms">
                                                <label>Language Proficiency <span class="login-danger">*</span> </label>
                                                <input class="form-control <?php echo $lg_proficiency_red_border ?>" type="text" name="lg_proficiency" value="<?php echo $lg_proficiency ?>">
                                                <div class="error"><?php echo $lg_proficiency_err ?></div>
                                            </div>
                                        </div>
                                        <div class="col-12 col-sm-4">       <!-- New elemant -->
                                            <div class="form-group local-forms">
                                                <label>Position <span class="login-danger">*</span> </label>
                                                <input class="form-control <?php echo $position_red_border ?>" type="number" name="position" value="<?php echo $position ?>">
