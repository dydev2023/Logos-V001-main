    ...
    if (isset($_REQUEST['submit'])) {
        ...
        if (!empty($classroom)) {
            try {
                ...
                $stmt1->execute();
                $_SESSION['success'] = "Add classroom successfully. <a href='classroom-list.php'> Click here to login </a>";
                header('location: classroom-add.php');
                exit;
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-12 col-sm-4">
                                            <div class="form-group local-forms">
                                                ...
                                                <input class="form-control <?php echo $classroom_red_border ?>" type="text" name="classroom" value="<?php echo $classroom ?>">
